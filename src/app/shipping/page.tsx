  ...
  return (
    <div className="pt-16 pb-24 md:pt-24">
      <Container size="narrow">
        <span className="label-text text-outline">Shipping</span>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="bg-surface-container-low p-8 md:p-10">
            ...
            <h2 className="mt-3 font-headline text-2xl font-light text-primary">
              Nationwide delivery
            </h2>
            <p className="mt-4 font-body text-[13px] leading-[1.7] text-on-surface-variant">
